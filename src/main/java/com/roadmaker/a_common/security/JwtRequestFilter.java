    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                memEmail = jwtUtil.validateAndExtractmemEmail(jwtToken);
        ...
        if (memEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            // DB에서 사용자 정보 가져오기
            UserDetails userDetails = this.userDetailsService.loadUserByUsername(memEmail);
            // 사용자와 토큰과 일치하는지 확인.
